...
import { getOverrideBalanceAPI } from '../services/overrideService';
...
export default function SubscriptionPlansScreen() {
  ...
  const handleConfirmPay = async () => {
    ...
    try {
      ...
      const confirmedPlan = (result?.planCode || newPlan) as 'free' | 'pro' | 'elite';
  ...
  return (
    <SafeAreaView style={s.container}>
      ...
      <ScrollView contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* NEW — navigates to BuyOverridesScreen instead of opening the old popup */}
        <TouchableOpacity
