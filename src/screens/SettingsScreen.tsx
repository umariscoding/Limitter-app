...
const styles = StyleSheet.create({
  ...
  signOutBtn: { marginTop: 16, paddingVertical: 12, paddingHorizontal: 20, backgroundColor: '#FEE2E2', borderRadius: 8, borderWidth: 1, borderColor: '#FECACA' },
  signOutBtnText: { color: '#B91C1C', fontWeight: '700' },
